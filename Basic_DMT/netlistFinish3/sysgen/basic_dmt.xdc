set rateCebasic_dmt2 basic_dmt_default_clock_driver/clockdriver_x5/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
set rateCellsbasic_dmt2 [get_cells -of [filter [all_fanout -flat -endpoints [get_pins $rateCebasic_dmt2/Q]] IS_ENABLE]]
set rateCebasic_dmt4 basic_dmt_default_clock_driver/clockdriver_x4/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
set rateCellsbasic_dmt4 [get_cells -of [filter [all_fanout -flat -endpoints [get_pins $rateCebasic_dmt4/Q]] IS_ENABLE]]
set rateCebasic_dmt5 basic_dmt_default_clock_driver/clockdriver_x3/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
set rateCellsbasic_dmt5 [get_cells -of [filter [all_fanout -flat -endpoints [get_pins $rateCebasic_dmt5/Q]] IS_ENABLE]]
set rateCebasic_dmt14 basic_dmt_default_clock_driver/clockdriver_x2/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
set rateCellsbasic_dmt14 [get_cells -of [filter [all_fanout -flat -endpoints [get_pins $rateCebasic_dmt14/Q]] IS_ENABLE]]
set rateCebasic_dmt16 basic_dmt_default_clock_driver/clockdriver_x1/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
set rateCellsbasic_dmt16 [get_cells -of [filter [all_fanout -flat -endpoints [get_pins $rateCebasic_dmt16/Q]] IS_ENABLE]]
set rateCebasic_dmt64 basic_dmt_default_clock_driver/clockdriver_x0/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
...
set_multicycle_path -from $rateCellsbasic_dmt2 -to $rateCellsbasic_dmt14 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt2 -to $rateCellsbasic_dmt14 -hold 1
...
set_multicycle_path -from $rateCellsbasic_dmt4 -to $rateCellsbasic_dmt14 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt4 -to $rateCellsbasic_dmt14 -hold 1
...
set_multicycle_path -from $rateCellsbasic_dmt5 -to $rateCellsbasic_dmt14 -setup 1
set_multicycle_path -from $rateCellsbasic_dmt5 -to $rateCellsbasic_dmt14 -hold 0
...
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt2 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt2 -hold 1
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt4 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt4 -hold 1
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt5 -setup 1
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt5 -hold 0
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt14 -setup 14
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt14 -hold 13
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt16 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt16 -hold 1
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt64 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt64 -hold 1
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt256 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt14 -to $rateCellsbasic_dmt256 -hold 1
...
set_multicycle_path -from $rateCellsbasic_dmt16 -to $rateCellsbasic_dmt14 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt16 -to $rateCellsbasic_dmt14 -hold 1
...
set_multicycle_path -from $rateCellsbasic_dmt64 -to $rateCellsbasic_dmt14 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt64 -to $rateCellsbasic_dmt14 -hold 1
...
set_multicycle_path -from $rateCellsbasic_dmt256 -to $rateCellsbasic_dmt14 -setup 2
set_multicycle_path -from $rateCellsbasic_dmt256 -to $rateCellsbasic_dmt14 -hold 1
