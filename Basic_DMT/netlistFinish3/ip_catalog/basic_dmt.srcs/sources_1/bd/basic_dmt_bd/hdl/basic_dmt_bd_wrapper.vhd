...
basic_dmt_bd_i: component basic_dmt_bd
    port map (
      clk => clk,
      inp_recv_im(20 downto 0) => inp_recv_im(20 downto 0),
      inp_recv_re(20 downto 0) => inp_recv_re(20 downto 0),
      inp_trans(0) => inp_trans(0),
      out_recv(0) => out_recv(0),
      out_trans_im(20 downto 0) => out_trans_im(20 downto 0),
      out_trans_re(20 downto 0) => out_trans_re(20 downto 0)
    );
end STRUCTURE;
