...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {D:/MA_1/Basic_DMT/netlistFinishDMT1}
	set TestBenchModule {basic_dmt_tb}
	set TopLevelModule {basic_dmt}
	set TopLevelSimulinkHandle 177.016
	...
	dict set TopLevelPortInterface inp_recv_re Type Fix_21_13
	dict set TopLevelPortInterface inp_recv_re ArithmeticType xlSigned
	dict set TopLevelPortInterface inp_recv_re BinaryPoint 13
	dict set TopLevelPortInterface inp_recv_re Width 21
	...
	dict set TopLevelPortInterface inp_recv_im Type Fix_21_13
	dict set TopLevelPortInterface inp_recv_im ArithmeticType xlSigned
	dict set TopLevelPortInterface inp_recv_im BinaryPoint 13
	dict set TopLevelPortInterface inp_recv_im Width 21
	...
	dict set TopLevelPortInterface out_trans_im Type Fix_21_13
	...
	dict set TopLevelPortInterface out_trans_im Width 21
	...
	dict set TopLevelPortInterface out_trans_re Type Fix_21_13
	...
	dict set TopLevelPortInterface out_trans_re Width 21
