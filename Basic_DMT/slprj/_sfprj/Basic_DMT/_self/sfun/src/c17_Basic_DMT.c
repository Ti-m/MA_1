...
static const char * c17_debug_family_names[8] = { "nargin", "nargout", "sent",
  "recv", "rst", "sent_out", "error", "ber" };

/* Function Declarations */
static void initialize_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct
  *chartInstance);
static void initialize_params_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct
  *chartInstance);
static void enable_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct *chartInstance);
static void disable_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_Basic_DMT
  (SFc17_Basic_DMTInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct *
  chartInstance);
static void set_sim_state_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct
  *chartInstance, const mxArray *c17_st);
static void finalize_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct *chartInstance);
static void sf_gateway_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct
  *chartInstance);
static void mdl_start_c17_Basic_DMT(SFc17_Basic_DMTInstanceStruct *chartInstance);
static void initSimStructsc17_Basic_DMT(SFc17_Basic_DMTInstanceStruct
  *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_emlrt_marshallIn(SFc17_Basic_DMTInstanceStruct *chartInstance,
  const mxArray *c17_b_ber, const char_T *c17_identifier);
static real_T c17_b_emlrt_marshallIn(SFc17_Basic_DMTInstanceStruct
...
static const mxArray *c17_d_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_c_emlrt_marshallIn(SFc17_Basic_DMTInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_d_emlrt_marshallIn(SFc17_Basic_DMTInstanceStruct
  *chartInstance, const mxArray *c17_b_is_active_c17_Basic_DMT, const char_T
  *c17_identifier);
static uint8_T c17_e_emlrt_marshallIn(SFc17_Basic_DMTInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static real_T c17_get_ber_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_elementIndex);
static void c17_set_ber_r(SFc17_Basic_DMTInstanceStruct *chartInstance, uint32_T
  c17_elementIndex, real_T c17_elementValue);
static real_T *c17_access_ber_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_rdOnly);
static real_T c17_get_error_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_elementIndex);
static void c17_set_error_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_elementIndex, real_T c17_elementValue);
static real_T *c17_access_error_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_rdOnly);
static real_T c17_get_sent_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_elementIndex);
static void c17_set_sent_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_elementIndex, real_T c17_elementValue);
static real_T *c17_access_sent_r(SFc17_Basic_DMTInstanceStruct *chartInstance,
  uint32_T c17_rdOnly);
static void init_dsm_address_info(SFc17_Basic_DMTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc17_Basic_DMTInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_Basic_DMT = 0U;
}
  ...
  chartInstance)
{
  ...
  c17_c_hoistedGlobal = *chartInstance->c17_sent_out;
  ...
  c17_d_hoistedGlobal = chartInstance->c17_is_active_c17_Basic_DMT;
  ...
  *chartInstance, const mxArray *c17_st)
{
  ...
  *chartInstance->c17_sent_out = c17_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c17_u, 2)), "sent_out");
  chartInstance->c17_is_active_c17_Basic_DMT = c17_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 3)),
     "is_active_c17_Basic_DMT");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_Basic_DMT(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c17_nargout, 1U, c17_sf_marshallOut,
    c17_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c17_b_sent, 2U, c17_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c17_b_recv, 3U, c17_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c17_b_rst, 4U, c17_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c17_b_sent_out, 5U, c17_sf_marshallOut,
    c17_sf_marshallIn);
  ...
  c17_set_sent_r(chartInstance, 0, c17_get_sent_r(chartInstance, 0) + 1.0);
  ssUpdateDataStoreLog(chartInstance->S, 2);
  _SFD_EML_CALL(0U, chartInstance->c17_sfEvent, 9);
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, (real_T)c17_b_sent,
        (real_T)c17_b_recv, 0, 1U, c17_b_sent != (int32_T)c17_b_recv))) {
  ...
  c17_e_hoistedGlobal = c17_get_sent_r(chartInstance, 0);
  ...
  if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c17_b_rst, 1.0, -1, 0U,
    ...
    c17_set_sent_r(chartInstance, 0, 0.0);
    ssUpdateDataStoreLog(chartInstance->S, 2);
  ...
  c17_b_sent_out = c17_get_sent_r(chartInstance, 0);
  ...
  *chartInstance->c17_sent_out = c17_b_sent_out;
  ...
  *chartInstance->c17_ber = c17_b_ber;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c17_sent_out, 1U);
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_Basic_DMTInstanceStruct *chartInstance;
  chartInstance = (SFc17_Basic_DMTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c17_Basic_DMT_get_eml_resolved_functions_info(void)
{
  ...
  *c17_identifier)
{
  ...
  c17_y = c17_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_Basic_DMT), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_Basic_DMT);
  return c17_y;
}
  ...
  uint32_T c17_elementIndex)
{
  ...
  return *chartInstance->c17_sent_r_address;
}
  ...
  uint32_T c17_elementIndex, real_T c17_elementValue)
{
  ...
  *chartInstance->c17_sent_r_address = c17_elementValue;
}
  ...
  uint32_T c17_rdOnly)
{
  ...
  c17_dsmAddr = chartInstance->c17_sent_r_address;
  if (c17_rdOnly == 0U) {
...
static void init_dsm_address_info(SFc17_Basic_DMTInstanceStruct *chartInstance)
{
  ...
  ssGetSFcnDataStoreNameAddrIdx_wrapper(chartInstance->S, "sent_r", (void **)
    &chartInstance->c17_sent_r_address, &chartInstance->c17_sent_r_index);
}

static void init_simulink_io_address(SFc17_Basic_DMTInstanceStruct
  *chartInstance)
{
  chartInstance->c17_sent = (uint8_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c17_sent_out = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
...
void sf_c17_Basic_DMT_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(207565169U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3157647889U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(144396001U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(851482278U);
}

mxArray* sf_c17_Basic_DMT_get_post_codegen_info(void);
mxArray *sf_c17_Basic_DMT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c17_Basic_DMT_get_post_codegen_info();
...
mxArray *sf_c17_Basic_DMT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_Basic_DMT_jit_fallback_info(void)
{
...
mxArray *sf_c17_Basic_DMT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c17_Basic_DMT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[40],T\"ber\",},{M[1],M[6],T\"error\",},{M[1],M[10],T\"sent_out\",},{M[8],M[0],T\"is_active_c17_Basic_DMT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_Basic_DMT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc17_Basic_DMTInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,129,141,0,1);
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c17_sent);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c17_sent_out);
        ...
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c17_sent_r_address);
...
{
  return "yZYYT6n9tffu1xW8SiWXbF";
}

static void sf_opaque_initialize_c17_Basic_DMT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*)
    chartInstanceVar);
  initialize_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c17_Basic_DMT(void *chartInstanceVar)
{
  enable_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c17_Basic_DMT(void *chartInstanceVar)
{
  disable_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c17_Basic_DMT(void *chartInstanceVar)
{
  sf_gateway_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c17_Basic_DMT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c17_Basic_DMT(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c17_Basic_DMT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc17_Basic_DMT((SFc17_Basic_DMTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_Basic_DMT(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c17_Basic_DMT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3748072207U));
  ssSetChecksum1(S,(3153228906U));
  ssSetChecksum2(S,(1482075972U));
  ssSetChecksum3(S,(997744920U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,0);
}

static void mdlRTW_c17_Basic_DMT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_Basic_DMT(SimStruct *S)
{
  SFc17_Basic_DMTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc17_Basic_DMTInstanceStruct *)utMalloc(sizeof
    (SFc17_Basic_DMTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_Basic_DMTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c17_Basic_DMT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c17_Basic_DMT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c17_Basic_DMT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c17_Basic_DMT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c17_Basic_DMT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c17_Basic_DMT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c17_Basic_DMT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c17_Basic_DMT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_Basic_DMT;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_Basic_DMT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c17_Basic_DMT;
...
void c17_Basic_DMT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_Basic_DMT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_Basic_DMT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_Basic_DMT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_Basic_DMT_method_dispatcher.\n"
